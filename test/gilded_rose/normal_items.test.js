...
/* GENERAL TESTS FOR NORMAL ITEM */
describe("Normal item in shop", function() {
...
describe("Normal item in running shop", function() {
...
describe("Normal item in running shop within sell in days", function() {
  it("decreases quality by 1", function() {
    ...
    for (i = sellIn; i > 0; i--) {
      const expectedQuality = item.quality - 1 >= 0 ? item.quality - 1 : 0;
      const shopItems = shop.updateQuality();
      item = shopItems[0];
...
describe("Normal item in running shop after sell in days", function() {
